...
export default class CannonDebugRenderer {
    ...
    private tmpVec0: CANNON.Vec3
    private tmpVec1: CANNON.Vec3
    private tmpVec2: CANNON.Vec3
    private tmpQuat0: CANNON.Quaternion
    ...
    private _particleGeometry: THREE.BufferGeometry<THREE.NormalBufferAttributes>
    constructor(scene, world, options: any = null) {
